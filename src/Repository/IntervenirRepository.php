...
/**
 * @extends ServiceEntityRepository<Intervenir>
 *
...
class IntervenirRepository extends ServiceEntityRepository
{
    ...
    public function save(Intervenir $entity, bool $flush = false): void
    {
    ...
    public function remove(Intervenir $entity, bool $flush = false): void
    {
