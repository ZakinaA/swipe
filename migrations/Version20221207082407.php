 ...
 */
final class Version20221207082407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD responsable_id INT DEFAULT NULL, ADD professeur_id INT DEFAULT NULL, ADD eleve_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte DROP responsable_id, DROP professeur_id, DROP eleve_id');
    }
}
